...
+function ($) { "use strict";
  ...
  ZoomService.prototype._zoom = function (e) {
    ...
    if ((window.allowZoom) && (!window.isMobile)) {
...
(function(document, window) {
  ...
  document.addEventListener("DOMContentLoaded", function() {
		...
		[].slice.call(document.querySelectorAll("use[*|href]")).filter(function(element) { return (element.getAttribute("xlink:href").indexOf("#") === 0); }).forEach(function(element) { element.setAttribute("xlink:href", baseUrl + element.getAttribute("xlink:href")); });}, false);
