...
window.isChromeiPad = navigator.userAgent.match('CriOS'); 
window.isMSIE = navigator.userAgent.match('MSIE');
window.isAndroid = (navigator.userAgent.indexOf('Mozilla/5.0') > -1 && navigator.userAgent.indexOf('Android ') > -1 && navigator.userAgent.indexOf('AppleWebKit') > -1);
...
$(document).ready(function() {  "use strict";
  ...
  if((window.isChromeiPad)||(window.isAndroid)) {
  ...
  function updateHash(){
    ...
    if ((isHash)&&($('.slide[name="' +isHash+ '"]').length>0)) {
      ...
      if (!$body.hasClass('simplifiedMobile')){
  ...
  */ 
  ...
  function showSlide(requested){
    ...
    //set hash
    if (newSlide.attr('name')) { window.location.hash = newSlide.attr('name'); }
